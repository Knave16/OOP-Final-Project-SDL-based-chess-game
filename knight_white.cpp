...
If this condition is met, it also updates the moverRect coordinates to the new position (x, y).*/
    ...
    string knight_white:: getType(){return "White_Knight";}//Returns a string identifying the type of the piece ("White_Knight").
    ...
    knight_white:: ~knight_white(){}//// Destructor for the white knight